...
contract UniswapV4AcrossSettlerTest is TestContext, UniswapV4Helpers {
    ...
    */
    ...
    function test_handleV3AcrossMessage_ST_Token1BaseToken_BelowCurrentTick() public {
        ...
        vm.recordLogs();
        // generate data
        (bytes32 migrationId, bytes memory data) = genSettlerData(poolKey, SettlementHelpers.Range.BelowTick, false);
    ...
    function test_handleV3AcrossMessage_ST_Token1BaseToken_AboveCurrentTick() public {
        ...
        vm.recordLogs();
        // generate data
        (bytes32 migrationId, bytes memory data) = genSettlerData(poolKey, SettlementHelpers.Range.AboveTick, false);
