...
import {IDualTokensV3V4Migrator} from "src/interfaces/IDualTokensV3V4Migrator.sol";
...
contract DualTokensV3V4MigratorTest is Test {
    ...
    DualTokensV3V4Migrator private migrator;
    IDualTokensV3V4Migrator.MigrationParams private migrationParams;
    ...
    function setUp() public {
        ...
        migrator = new DualTokensV3V4Migrator(address(positionManager), address(spokePool));
        ...
        migrationParams = IDualTokensV3V4Migrator.MigrationParams({
    ...
    function test_fuzz_chainSetterNotSet(uint256 chainId) public {
        ...
        vm.expectRevert(DualTokensV3V4Migrator.DestinationChainSettlerNotFound.selector);
    ...
    function test_migragePositionBelowPrice() public {
        ...
        emit IDualTokensV3V4Migrator.Migrate(
            bytes32(0),
            positionBelowPrice,
