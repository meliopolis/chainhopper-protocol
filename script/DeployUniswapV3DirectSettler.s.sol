...
/*  
    forge script script/DeployUniswapV3DirectSettler.s.sol:DeployUniswapV3DirectSettler \
...
contract DeployUniswapV3DirectSettler is Script {
    function run(string memory env, address initialOwner) public {
        vm.startBroadcast(vm.envUint("PRIVATE_KEY"));

        UniswapV3DirectSettler settler = new UniswapV3DirectSettler(
            initialOwner,
        ...
        console.log("UniswapV3DirectSettler deployed at:", address(settler));
