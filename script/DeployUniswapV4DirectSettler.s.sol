...
import {UniswapV4DirectSettler} from "../src/UniswapV4DirectSettler.sol";

/*
    forge script script/DeployUniswapV4DirectSettler.s.sol:DeployUniswapV4DirectSettler \
...
contract DeployUniswapV4DirectSettler is Script {
    function run(string memory env, address initialOwner) public {
        vm.startBroadcast(vm.envUint("PRIVATE_KEY"));

        UniswapV4DirectSettler settler = new UniswapV4DirectSettler(
            initialOwner,
        ...
        console.log("UniswapV4DirectSettler deployed at:", address(settler));
