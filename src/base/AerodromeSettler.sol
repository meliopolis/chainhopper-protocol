...
import {IAerodromeSettler} from "../interfaces/IAerodromeSettler.sol";
import {AerodromeLibrary} from "../libraries/AerodromeLibrary.sol";
import {Settler} from "./Settler.sol";

/// @title AerodromeSettler
/// @notice Contract for settling migrations on Aerodrome
abstract contract AerodromeSettler is IAerodromeSettler, Settler {
    ...
    function _mintPosition(
        ...
        uint256 amount0Used;
        uint256 amount1Used;
        (positionId,, amount0Used, amount1Used) = AerodromeLibrary.mintPosition(
            positionManager,
            mintParams.token0,
            mintParams.token1,
            mintParams.tickSpacing,
            ...
            recipient,
            mintParams.sqrtPriceX96 // if sqrtPriceX96 is not 0, the pool will be created and initialized
        );
